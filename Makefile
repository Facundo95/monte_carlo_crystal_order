...
SRCS = main.cpp simulation.cpp rng.cpp file_handler.cpp lattice.cpp lattice_output.cpp input_parser.cpp mc_helpers.cpp neighbor_sums.cpp sweep_list.cpp beg_hamiltonian.cpp ising_hamiltonian.cpp
OBJS = $(SRCS:.cpp=.o)
DOXYGEN = doxygen
DOXYFILE = Doxyfile
